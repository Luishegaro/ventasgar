...
<div class="row">
        <?php $form = ActiveForm::begin([
            ...
            <div class="col-xs-6 col-md-2">
                <?= $form->field($model, 'numero')->textInput(["placeholder"=>"NUMERO DE RECIBO"])->label(false) ?>
            </div>
            <div class="col-xs-6 col-md-2">
            ...
            <div class="form-group col-xs-12 col-md-4">
                    ...
                    <?= Html::a('Crear Recibo',['create-recibo'], ['class' => 'btn btn-success','style'=>'margin-right:10px;']) ?>
            </div>
        <?php ActiveForm::end(); ?>
        <div class="col-md-12">

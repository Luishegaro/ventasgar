...
<table height="157" style="text-align: center;">
  <tbody>
    ...
    <tr>
      ...
      <p>N&ordm;: <?= $model["id_gasto"]?></p>

      <p><strong>Egreso Bs.: </strong><?= $model["monto"]?></p>
      <hr>
      </td>
    </tr>
  </tbody>
...
<table border="0" cellpadding="0" cellspacing="0" height="53" width="320">
  <tbody>
  <tr>
    ...
    <tr>
      <td style="width:360px;height:16px;">
      <p><span style="font-size:14px;"><strong>Pagado a:</strong> <?= $model["pagado_a"]?></span></p>
      </td>
    </tr>
